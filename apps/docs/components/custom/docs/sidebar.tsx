...
import { FolderProvider, useFolderContext } from '@/context/use-folder-context';
...
export const SidebarFolderContent = ({
  ...
  return (
    <CollapsibleContent>
      <SidebarMenuSub className="m-0 my-2.5 ml-2 flex flex-col gap-y-2.5 border-none p-0">
        {children}
      </SidebarMenuSub>
    </CollapsibleContent>
  );
