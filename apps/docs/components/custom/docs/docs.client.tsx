...
import { AlignmentLeft, ChevronLeft, ChevronRight } from '@vercel/geist/icons';
  ...
  return (
    <div className="grid w-full grid-cols-2 gap-4 md:mt-4 md:pb-6">
      {neighbours.previous ? (
        ...
        >
          <div className="flex items-center justify-center gap-x-1.5 text-gray-900 text-label-14">
            <ChevronLeft className="translate-y-px" size={10} />
            Previous
          </div>
      ...
      {neighbours.next ? (
        ...
        >
          <div className="flex items-center justify-center gap-x-1.5 text-gray-900 text-label-14">
            Next <ChevronRight className="translate-y-px" size={10} />
          </div>
          <span className="font-medium text-gray-1000 text-label-16">
