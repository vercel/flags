...
- **Edge Middleware** runs globally, in a CDN.
...
previous section. This means you can use feature flags in Edge
...
requests, such that Edge Middleware can establish the evaluation context
