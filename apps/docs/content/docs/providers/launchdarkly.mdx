...
- `EXPERIMENTATION_CONFIG` _(required)_ → `globalConfigConnectionString`
...
The LaunchDarkly adapter loads the configuration from [Global Config](https://vercel.com/storage/edge-config).
