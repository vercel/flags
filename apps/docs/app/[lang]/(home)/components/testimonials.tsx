...
export const Card = ({ name, alias, avatar, url, children }: CardProps) => {
  return (
    <Link
      href={url}
      target="_blank"
      className="rounded-xl border px-6 py-5 transition-colors hover:bg-background"
    >
...
export const Testimonials = () => {
  return (
    <div className="mb-6 mt-7 grid grid-cols-1 gap-4 min-[780px]:grid-cols-3 p-8 px-4 py-8 sm:p-12 sm:px-12 sm:py-12">
