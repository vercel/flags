const exampleUrl =
  'https://github.com/vercel/flags/tree/main/examples/providers/statsig';
...
const deployUrl = `https://vercel.com/new/clone?${new URLSearchParams({
  ...
  'project-name': 'flags-sdk-statsig',
  'repository-name': 'flags-sdk-statsig',
  products: JSON.stringify([
    {
      integrationSlug: 'statsig',
      productSlug: 'statsig',
      type: 'integration',
