...
export default async function Home() {
  ...
  return (
    <main>
      ...
      />
      <p>Flags SDK + Reflag</p>
      <h1>{message ? 'Hello from Reflag' : 'Welcome to the Reflag example'}</h1>
      {banner && <aside>The feature flag enabled this banner.</aside>}
      <p>
        Change <code>welcome_message</code> or <code>show_banner</code> in
        Reflag, then refresh this page.
      </p>
      <a href="https://flags-sdk.dev/providers/reflag">Adapter documentation</a>
    </main>
  );
}
