...
<div class="flex flex-col gap-2">
  {#if data.flag1}
    <div class="rounded-md bg-green-100 dark:bg-green-800">
      <div class="p-4 text-sm font-medium text-green-800 dark:text-green-100">
        The feature flag <span class="font-semibold">firstMarketingABTest</span>
        evaluated to
  ...
  {:else}
    <div class="rounded-md bg-fuchsia-100 dark:bg-fuchsia-800">
      <div
        class="p-4 text-sm font-medium text-fuchsia-800 dark:text-fuchsia-100"
      >
        The feature flag <span class="font-semibold">firstMarketingABTest</span>
        evaluated to
  ...
  {#if data.flag2}
    <div class="rounded-md bg-green-100 dark:bg-green-800">
      <div class="p-4 text-sm font-medium text-green-800 dark:text-green-100">
        The feature flag <span class="font-semibold">secondMarketingABTest</span
        >
        evaluated to
        <span class="font-semibold">true</span>.
      </div>
