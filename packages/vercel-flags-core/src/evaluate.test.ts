...
describe('evaluate', () => {
  ...
  it.each<{
    ...
    // CONTAINS
    {
      name: `${Comparator.INCLUDES} match`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'wilk'],
      entities: { user: { id: 'joewilkinson' } },
      result: true,
    },
    {
      name: `${Comparator.INCLUDES} miss`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'smith'],
      entities: { user: { id: 'joewilkinson' } },
      result: false,
    },
    {
      name: `${Comparator.INCLUDES} unset`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'wilk'],
      entities: { user: {} },
      result: false,
    },
    {
      name: `${Comparator.INCLUDES} invalid`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'wilk'],
      entities: { user: { id: null } },
      result: false,
    },
    ...
    // NOT_CONTAINS
    {
      name: `${Comparator.NOT_INCLUDES} match`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'smith'],
      entities: { user: { id: 'joewilkinson' } },
      result: true,
    },
    {
      name: `${Comparator.NOT_INCLUDES} miss`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'wilk'],
      entities: { user: { id: 'joewilkinson' } },
      result: false,
    },
    {
      name: `${Comparator.NOT_INCLUDES} unset`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'smith'],
      entities: { user: {} },
      result: false,
    },
    {
      name: `${Comparator.NOT_INCLUDES} invalid`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'smith'],
      entities: { user: { id: null } },
      result: false,
    },
    ...
    // CONTAINS 'i'
    {
      name: `${Comparator.INCLUDES} case-insensitive match (different case, 'i')`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'WILK', 'i'],
      entities: { user: { id: 'joewilkinson' } },
      result: true,
    },
    {
      name: `${Comparator.INCLUDES} case-insensitive miss ('i')`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'smith', 'i'],
      entities: { user: { id: 'joewilkinson' } },
      result: false,
    },
    {
      name: `${Comparator.INCLUDES} case-insensitive unset ('i')`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'WILK', 'i'],
      entities: { user: {} },
      result: false,
    },
    {
      name: `${Comparator.INCLUDES} case-insensitive invalid ('i')`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'WILK', 'i'],
      entities: { user: { id: null } },
      result: false,
    },
    ...
    // NOT_CONTAINS 'i'
    {
      name: `${Comparator.NOT_INCLUDES} case-insensitive match ('i')`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'smith', 'i'],
      entities: { user: { id: 'joewilkinson' } },
      result: true,
    },
    {
      name: `${Comparator.NOT_INCLUDES} case-insensitive miss (different case, 'i')`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'WILK', 'i'],
      entities: { user: { id: 'joewilkinson' } },
      result: false,
    },
    {
      name: `${Comparator.NOT_INCLUDES} case-insensitive unset ('i')`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'smith', 'i'],
      entities: { user: {} },
      result: false,
    },
    {
      name: `${Comparator.NOT_INCLUDES} case-insensitive invalid ('i')`,
      condition: [['user', 'id'], Comparator.NOT_INCLUDES, 'smith', 'i'],
      entities: { user: { id: null } },
      result: false,
    },
    ...
    {
      name: `${Comparator.INCLUDES} case-insensitive match (different case, { i: true })`,
      condition: [['user', 'id'], Comparator.INCLUDES, 'WILK', { i: true }],
      entities: { user: { id: 'joewilkinson' } },
      result: true,
    },
