...
The controller supplies source freshness, staleness, and revalidation callbacks to the cache. HeaderSource keeps version observations; the cache handles serving, background/blocking refreshes, shared work, cancellation, and stale-if-error. Streaming/polling retain their existing schedules.
